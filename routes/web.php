...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::prefix('reports')->name('reports.')->group(function () {
        ...
        Route::get('/monthly-purchases/pdf', [ReportController::class, 'exportMonthlyPurchasesPdf'])->name('monthly-purchases.pdf');
        Route::get('/pump-ledger/export', [ReportController::class, 'exportPumpLedger'])->name('pump-ledger.export');
        Route::get('/pump-ledger/pdf', [ReportController::class, 'exportPumpLedgerPdf'])->name('pump-ledger.pdf');
        ...
        Route::get('/vehicle-wise/pdf', [ReportController::class, 'exportVehicleWisePdf'])->name('vehicle-wise.pdf');
        Route::get('/driver-wise/export', [ReportController::class, 'exportDriverWise'])->name('driver-wise.export');
        Route::get('/driver-wise/pdf', [ReportController::class, 'exportDriverWisePdf'])->name('driver-wise.pdf');
        Route::get('/payments/export', [ReportController::class, 'exportPayments'])->name('payments.export');
        Route::get('/payments/pdf', [ReportController::class, 'exportPaymentsPdf'])->name('payments.pdf');
